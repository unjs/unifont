...
That's deliberate. Check out [`fontless`](https://github.com/unjs/fontaine/tree/main/packages/fontless) for zero-config integration for Vite, or the [`@nuxt/fonts`](https://fonts.nuxt.com), the equivalent for Nuxt. Or build your own integration: [Reducing layout shift](/docs/layout-shift) shows both paths.
